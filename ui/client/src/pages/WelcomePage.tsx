...
export function WelcomePage({ onNavigateToChat }: WelcomePageProps) {
...
└── CLAUDE.md                 # Development guide`}
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Experience the power of AI-driven research with your Deep Research Agent. 
              Get comprehensive, multi-source answers to any question.
            </p>
            <Button 
        ...
        <div className="text-center mt-12 pt-8 border-t">
          <p className="text-muted-foreground">
            This Deep Research Agent is powered by your deployed Databricks model. 
            Check out the{" "}
            <a
              href="http://localhost:8000/docs"
              target="_blank"
