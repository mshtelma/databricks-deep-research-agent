...
This file defines the ResearchTool protocol that all tools must implement.
Both core tools (web_search, web_crawl, vector_search, knowledge_assistant)
and plugin-provided tools follow this protocol.

Location: src/deep_research/agent/tools/base.py
"""
...
# Type alias for tool collections
