...
class OrchestrationConfig:
    ...
    # =========================================================================
    # Framework Delegation (011-multi-agent-framework)
    # =========================================================================
    use_framework: bool = True
    """Deprecated compatibility flag.

    The framework orchestrator is the only supported production path and this
    flag is no longer consulted at runtime.
    """
...
async def stream_research(
    ...
    # Framework delegation — the only supported production path.
