...
_TOOL_KIND_META: dict[str, dict[str, Any]] = {
    ...
    "compute": {"layer": "C", "config_schema": _EMPTY_SCHEMA},
    "compute_namespace": {"layer": "C", "config_schema": _EMPTY_SCHEMA},
    "delta_read": {"layer": "B", "discoverable": True, "discovery_path": "delta_tables", "config_schema": _EMPTY_SCHEMA},
    "delta_grep": {"layer": "B", "discoverable": True, "discovery_path": "delta_tables", "config_schema": _EMPTY_SCHEMA},
    "delta_table_read": {"layer": "B", "discoverable": True, "discovery_path": "delta_tables", "config_schema": _EMPTY_SCHEMA},
    "table_read": {"layer": "B", "config_schema": _EMPTY_SCHEMA},
...
def tool_kinds_payload() -> list[dict[str, Any]]:
    ...
    migration; this endpoint exposes the currently executable ToolKind values
    with the richer registry shape expected by the editor.
    """
