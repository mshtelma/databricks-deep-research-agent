...
class SourceService(BaseRepository[Source]):
    ...
    async def create(
        ...
        Args:
            ...
            source_type: Type of source (web, vector_search, knowledge_assistant, custom).
    ...
    async def create_many(
        ...
        Args:
            research_session_id: Research session ID.
            sources: List of source data dicts. Supports 'type' field which maps
                     to source_type for compatibility with tool results.
        ...
        entities = [
            Source(
                ...
                # Map 'type' from tool results to source_type
                source_type=source_data.get("type", source_data.get("source_type", SourceType.WEB.value)),
                source_metadata=source_data.get("metadata", source_data.get("source_metadata")),
            )
