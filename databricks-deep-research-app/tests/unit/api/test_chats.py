...
class TestGetChat:
    ...
    def test_get_existing_chat(
        ...
        with patch("deep_research.api.v1.chats.ChatService") as MockService:
            ...
            mock_service.get_for_user.assert_awaited_once_with(mock_chat.id, "test-user-123")
...
class TestUpdateChat:
    ...
    def test_update_chat_title(
        ...
        with patch("deep_research.api.v1.chats.ChatService") as MockService:
            ...
            call_kwargs = mock_service.update_chat.call_args.kwargs
...
class TestDeleteChat:
    ...
    def test_delete_existing_chat(
        ...
        with patch("deep_research.api.v1.chats.ChatService") as MockService:
            ...
            mock_service.soft_delete.assert_awaited_once_with(mock_chat.id, "test-user-123")
...
class TestRestoreChat:
    ...
    def test_restore_deleted_chat(
        ...
        with patch("deep_research.api.v1.chats.ChatService") as MockService:
            ...
            mock_service.restore.assert_awaited_once_with(mock_chat.id, "test-user-123")
