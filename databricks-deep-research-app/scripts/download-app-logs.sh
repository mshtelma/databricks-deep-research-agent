...
# Example: ./scripts/download-app-logs.sh deep-research-agent-dev e2-demo-west
#          ./scripts/download-app-logs.sh deep-research-agent-dev e2-demo-west -f
#          ./scripts/download-app-logs.sh deep-research-agent-dev e2-demo-west --search ERROR
#
