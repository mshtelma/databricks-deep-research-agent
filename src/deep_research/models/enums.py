...
class SourceType(str, Enum):
    ...
    - WEB: Standard web page from web search
    - VECTOR_SEARCH: Result from Databricks Vector Search
    - KNOWLEDGE_ASSISTANT: Result from Knowledge Assistant endpoint
    - CUSTOM: Plugin-provided source type
    """

    WEB = "web"  # Standard web search result
