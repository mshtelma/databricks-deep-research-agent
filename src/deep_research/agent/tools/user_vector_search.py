...
class UserVectorSearchTool:
    ...
    def __init__(
        ...
        # Cache for deduplication (content hash -> seen)
    ...
    def _deduplicate_results(
        ...
        Prevents duplicate content from appearing in results when
        the same document matches multiple times.
        """
        import hashlib
        ...
        for result in results:
            # Hash based on content (first 500 chars for efficiency)
