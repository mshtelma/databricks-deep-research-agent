...
from deep_research.agent.config import get_citation_config_for_depth
from deep_research.agent.state import ClaimInfo, EvidenceInfo, ResearchState, SourceInfo
...
from deep_research.services.citation.content_evaluator import evaluate_content_quality
...
class CitationVerificationPipeline:
    ...
    async def _run_classical_synthesis(
        ...
        """
        from deep_research.agent.nodes.synthesizer import stream_synthesis
